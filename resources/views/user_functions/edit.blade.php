        ...
        <div class="card-block">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    @endif
                    <form action="{{url('user/function/permission/update')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="role_id" id="role_id" class="form-control" required>
                                        ...
                                        @foreach($fs as $d)
                                        <option value="{{$d->user_id}}" {{$d->user_id==$per->user_id?'selected':''}}>{{$d->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
