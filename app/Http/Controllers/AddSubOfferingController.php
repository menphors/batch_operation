...
class AddSubOfferingController extends Controller
{
    ...
    public function index()
    {
        ...
        ->paginate(10);
        return view('add_sub_offer.index',$customer_info);
    }
    ...
    public function add_sub_offer(Request $request)
    {
     ...
     mysqli_close($conn);
        ...
        for($i=1;$i<count($cust_info[0]) ; $i++){
            ...
            $variableMessage=$this->NGBSSService->AddSubOffer($number, $offer_id);
